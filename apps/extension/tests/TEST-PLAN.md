...
`prototypes/extention/reference.json` identifies the only approved extension visual reference. Tests fail when a newer immutable `simplified-ui-vN.html` file exists without moving that pointer.
